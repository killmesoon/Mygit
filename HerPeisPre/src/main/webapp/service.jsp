		       ...
		       .done(function(data) {
		    	   ...
		    	   $.each(data,function(i,val){
		    		   ...
		    		   $('#conn').append(
		    				   ...
		    				   "<div class='col-item' id='div"+val.id+"'   >"+
		    	    ...
		    	    " <img  src='images/demon.png'>   "+ 
		    	                    ...
		    	                    "<div   style='float: left;height: 100%;width: 40%;padding-left: 25px;margin-top: 10px;'>"+
		    	                     " <h3 class='col-two-a'><a href='#'>"+val.iname+"</a></h3>"+
		    	                     "<p class='col-three-a'><span style='color: #999999;'>体检中心:</span><a href='#'>北京标软体检中心</a></p>"+
		    	                     "<p><span style='color: #999999;'>适宜人群:</span>"+val.isex+"性</p>"+
		    	                    ...
		    	                    "<a   style='display: block;background-color:#3b7ab8;color:#fff;font-size: 15px;height: 40px;margin-top:40px;line-height:40px;' "+
		    	                    
		    	                    "href='detail.jsp?name="+val.iname+"&sex="+val.isex+"&id="+val.id+"&price="+val.iprice+"'> "+
		    	                   ...
		    	                   " </div>"+
		    	                     ...
		    	                     "<div style='float: right;height: 100%;width: 15%;border-left: 1px dashed #ddd;border-right: 1px dashed #ddd;margin-right: 1%;text-align:center'>"+
		    	                           " <p style='line-height: 110px;'><span style='font-size: 30px;font-weight: bold;color:#ff9405; '>￥"+val.iprice+"</span></p>"+
...
<body style="font-family: '微软雅黑' ">
   ...
   <div  style="margin-top: 20px;margin-left: 15%; " >
    ...
    <!-- 套餐的选择条目 -->
     ...
     <c:when test="${list.isex=='男' }"> <img style="" src="images/demo1.png">    
      </c:when>  
     ...
     <c:otherwise> <img style="" src="images/demo3.png"> 
                    ...
                    <div   style="float: left;height: 100%;width: 40%;font-family: '微软雅黑';padding-left: 25px;margin-top: 10px; ">
                      <h3 class="col-two-a"><a href="#">${list.iname }</a></h3>
                     <p class="col-three-a"><span style="color: #999999;">体检中心:</span><a href="#">北京标软体检中心</a></p>
                     <p><span style="color: #999999;">适宜人群:</span>${list.isex }性</p>
                     <p><span style="color: #999999;">套餐介绍:</span>暂无介绍</p>    
                    </div>
                    ...
                    <a style="display: block;background-color:#3b7ab8;color:#fff;font-size: 15px;font-family: '微软雅黑';height: 40px;margin-top:35%;line-height:40px;" 
                     ...
                     href="detail.jsp?name=${list.iname}&id=${list.id}&price=${list.iprice}&sex=${list.isex}">查看详情</a>
                    <!-- 
                    <button id="" class="btn btn-primary" style="margin-top: 40%;" >查看详情</button>
                        <script type="text/javascript">
                          $('#button').click(function(){
                            window.open("detail.jsp?name=${list.iname}", "_self");
                          });
                        </script>
                     -->  
                    </div>
                     ...
                     <div style="float: right;height: 100%;width: 15%;border-left: 1px dashed #ddd;border-right: 1px dashed #ddd;margin-right: 1%;text-align:center">
                            <p style="line-height: 110px;"><span style="font-family: '微软雅黑';font-size: 30px;font-weight: bold;color:#ff9405; ">￥${list.iprice }</span></p>
