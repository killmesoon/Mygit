 ...
 <div class="header-nav">
   ...
   %>
		...
		<div class="container">
			...
			<div class="top-nav cl-effect-5">
				...
				<ul class="nav1">
					...
					<li><a href="news.jsp" class="active"> <span data-hover="体检报告">体检报告</span></a></li>
			...
			<form class="navbar-form navbar-right">
				<div class="form-group" style="font-family: '微软雅黑' ">
	...
	<!--news-->
      ...
      <div class="content">
   	  <span style="font-family: '微软雅黑'; font-size: 23px;line-height: 115px;border-bottom: 2px solid #3b7ab8;width: auto; ">报告查询</span>
